----------Main.m--------         the file to obtain the results for the three schemes (the proposed scheme, the benchmark with random energy beamforming, and the benchmark with equal time allocation) and plot Fig. 2 (b)
...
Please run "Main.m" to obtain Fig.2 (b)